...
public class ViewController {
    ...
    @GetMapping("/home")public String showHomePage(Model model) {
    ...
    @GetMapping("/admin/dashboard")public String showAdminPage(@RequestParam(value = "status", required = false) String status, Model model) {
    ...
    @PostMapping("/admin/updateStatus")public String updateReportStatus(@RequestParam("denunciaId") Long denunciaId,
    ...
    @GetMapping("/report")public String showReportPage(Model model) {
        return"report";
    }

    @GetMapping("/history")public String reportHistory(Model model, Principal principal) {
    ...
    @GetMapping("/info")public String showInfoPage() {
        return"info";
    }
}